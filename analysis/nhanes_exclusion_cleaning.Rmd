...
- not having menstrual period in past 12mo and not b/c they were pregnant, breastfeeding, or had a hysterectomy 
  -if had hysterectomy, are they below the avg age of menopause onset 49 yo

```{r}
# remove missing (N/A) values from RHQ031
fem_mega_data_1 <- drop_na(fem_mega_data, "RHQ031")

# remove participants who answer menopause (7), other (9), refused (77), don't know (99) to RHD043
fem_mega_data_2 <- subset(fem_mega_data_1, !(RHD043 %in% c(7, 9, 77, 99)))

# remove participants who answer >/= 49 to RIDAGEYR
