...
### Run univariate linear regression with Whole Spine BMD (DXXOSBMD) vs AFB (PBMDA)
```{r}
...
### Run univariate linear regression with Femoral Neck BMD (DXXOSBMD) vs AFB (PBMDA)
```{r}
