...
bmd_fert_fem_mega_data <- bmd_fert_fem_mega_data %>%
  mutate(PBMDA = ifelse(RHD180 < 20, 1, 0 ))
```
...
### Running univariate linear regression with Whole Spine BMD (DXXOSBMD) vs AFB (RHD180) 
```{r}
...
### Running univariate linear regression with Femoral Neck BMD (DXXLSBMD) vs AFB (RHD180)
```{r}
...
### Running univariate linear regression with Whole Spine BMD (DXXOSBMD) vs binary AFB (PBMDA)
```{r}
...
### Running univariate linear regression with Femoral Neck BMD (DXXOSBMD) vs binary AFB (PBMDA)
```{r}
...
### Running multivariate linear regression with Whole Spine BMD (DXXOSBMD) vs AFB (RHD180) + binary AFB (PBMDA)
```{r}

```

### Running multivariate linear regression with Femoral Neck BMD (DXXNKBMD) vs AFB (RHD180) + binary AFB (PBMDA)
```{r}
