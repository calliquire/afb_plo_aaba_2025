...
## Omit any participants without BMD data
```{r}
...
## Omit any participants who answered menopause (coded 7), medical conditions/treatments (coded 8), other (coded 9), refused (coded 77), don't know (coded 99) to RHQ04X (Why No Period?)
```{r}
# removes participants who aren't having periods b/c of menopause, another reason, medical reasons, or refused/don't know
# omitting participants who answered medical conditions/treatments (8) excludes data on individuals who may not be in 'good health'-- defined 'good health' in exclusion flowchart
data <- subset(data, !(RHQ04X %in% c(7, 8, 9, 77, 99)))
```
