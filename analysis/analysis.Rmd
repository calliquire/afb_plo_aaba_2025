...
plot5 <-
  ...
  labs(title = "Association between Age at First Birth and Bone Mineral Density", x = "Age at Time of Scan (yrs)", y = "Femoral Neck BMD (g/cm^2)", color = "AFB (yrs)") +
...
plot6 <- 
  ...
  scale_x_continuous(breaks = seq(0, 70, by = 5)) +
  labs(title = "Association between Parity and Bone Mineral Density", x = "Age at Time of Scan (yrs)", y = "Femoral Neck BMD (g/cm^2)", color = "Parity (live births/indiv.)") +
  geom_smooth(method = "lm", se = F)
print(plot6)
...
plot8 <-
  ...
  scale_fill_brewer(palette = "Set2", breaks=c('</= 18', '19-26', '>/= 27')) +
  scale_x_discrete(limits = c('1-3', '4-6', '7-9', '10+')) +
  geom_jitter(size = 0.4, alpha = 0.5) +
  labs(title = "Association between Parity & Age at First Birth and Bone Mineral Density", y =  "Femoral Neck BMD (g/cm^2)", x = "Parity (live births/indiv.)", fill = "AFB")
print(plot8)
```
