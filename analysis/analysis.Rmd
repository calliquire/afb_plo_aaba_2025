...
# there are multiple codes for some conditions due to inconsistencies of codes between sampling years 

# removes participants who answered medical conditions/treatments (6, 8)
# this excludes data on individuals who may not be in 'good health'-- defined 'good health' in exclusion flowchart
...
data <- data %>%
  mutate(PBMDA = ifelse(RHX180 < 20, "yes", "no" ))
```
...
# makes for simplified data fram (named "df") for analyses purposes
