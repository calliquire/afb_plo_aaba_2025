...
### Linear regression with BMD vs AFB b4 PMDA?
```{r}
lm_2 <-
  ggplot(df, aes(x = PkBMD, y = BMD)) +
    geom_boxplot(alpha = 0.7) +
    geom_jitter(size = 0.4, alpha = 0.4) +
    ggtitle("Bone Mineral Denisty vs Age at First Birth Before & At/After 20yo") + xlab("Age at First Birth (yrs)") + ylab("Femoral Neck BMD (g/cm^2)") + scale_color_discrete("Race/Ethnicity")
