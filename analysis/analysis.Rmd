...
# NHANES analysis protocols suggest not to take average of 5 values, and instead do a complicated process to account for extra variability; for the purposes of this study (and b/c there are so many respondents), chose to omit from set
