...
# combine DXXLLBMD and DXXOFBMD
data$DXXBMD <- coalesce(data$DXXLLBMD, data$DXXOFBMD)
...
df <- subset(data, select = -c(SDMVSTRA, SDMVPSU, WTMEC2YR, RHQ180, RHQ030, RHQ040, RHQ031, RHD042, RHD180, RHD043, DXXOFBMD, DXXLLBMD))
```
...
ulm_2_plot <-
  ggplot(ulm_2, aes(x = PkBMD, y = DXXBMD, fill = PkBMD)) +
    geom_boxplot(alpha = 0.7) +
    scale_y_continuous(breaks = seq(0, 1.5, by = 0.1)) +
    annotate("rect", xmin = -Inf, xmax = Inf, ymin = 0.85, ymax = 1, fill = "lightgreen", alpha = 0.2) +
    scale_color_viridis(discrete = TRUE, option = "E", aesthetics = "color") +
    geom_jitter(color = "black", size = 0.4, alpha = 0.4) +
    theme(
      legend.position = "none",
      plot.title = element_text(size=11)
    ) + 
    ggtitle("Bone mineral denisty vs age at first birth before & at/after 20 yo") + xlab("age at first birth before & at/after 20 yo") + ylab("bone mineral density (g/cm^2)")
