...
```{r}
# each participant from 1999-2006 has 5 repeat measures of BMD
# need to remove duplicates, then get average BMD values for those who had different values in 2+ of the 5 repeats

# for those who had the same BMD value for all 5 repeat measures, remove duplicate rows
df <- df %>% distinct(SEQN, RIAGENDR, RIDAGEYR, RHX180, DXXBMD, RHQ03X, RHQ04X, AFBb4PBMDA, .keep_all = TRUE)

# for those remaining who had different BMD values for the 5 repeat measures, take average BMD for each respondent
