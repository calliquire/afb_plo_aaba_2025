...
# diagnostic plots for each model (lm2-lm4)
plot_model_diagnostics <- function(model) {
  par(mfrow = c(2, 2))
  plot(model)  # Basic diagnostic plots
  par(mfrow = c(1, 1))
}
plot_model_diagnostics(lm2)
plot_model_diagnostics(lm3)
plot_model_diagnostics(lm4)


# visualize BMD v AGE in scatter plot 
plot1 <- 
...
# visualize BMD v AFB in scatter plot
plot2 <- 
