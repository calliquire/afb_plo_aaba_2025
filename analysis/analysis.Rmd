...
```{r}
# some individuals from the early years of the study have duplicate data
# not all respondents continue throughout the whole study, and new respondants crop up each year of the study
# remove all duplicate rows and leave one row per respondent
